...
hand: ""
world: ""
tags: [layered, cut-paper, shadow, tactile]
author: ppt-zen
license: CC-BY-4.0
prompt_formula: |
  SURFACE:  Entire scene built from cut and layered colored paper with soft real drop-shadows between layers — 5-6 depth layers. Palette - cream base, dusty blue, sage-free soft teal avoided — use cream, powder blue, blush coral, and one deep indigo layer. The hero is a paper diorama landscape - three paper towers rising from layered paper hills, each tower with a folded paper flag (blank unless the page's TEXT supplies that label); paper clouds and a paper sun with radiating cut rays. The page's TEXT cut out as crisp paper letters casting subtle shadow. Handcrafted, tactile, warm gallery-lighting feel.
