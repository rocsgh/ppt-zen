...
<div class="claim"><b>Full-image pages that hold up</b><span>Every slide is one designed image — typography, texture and illustration in the material you chose. English and dense data render clean; you proofread each page, and a miss regenerates in one command.</span></div>
<div class="claim"><b>Open source, your image model</b><span>Apache-2.0 judgment layer + CC-BY styles. Works with any agent that generates images, or any endpoint speaking the OpenAI images API. No key ships in the repo.</span></div>
</div>"""
    chain = """
...
<tr><td><b>Hermes</b></td><td><code>./install.sh hermes</code></td><td><code>~/.hermes/skills/creative/ppt-zen/</code></td><td>ask for a deck</td></tr>
